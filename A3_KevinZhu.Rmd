...
# Set gene-set file
geneset_file <- 
  "./A3/Human_GOBP_AllPathways_noPFOCR_no_GO_iea_March_01_2024_symbol.gmt" 
...
```
This step is OPTIONAL (it makes rendering this notebook much longer). If the 
user has not run any of the previous notebooks, this code block should 
...
de_df <- read.table(file = "./A2/top_outputs.txt", header = TRUE, sep = "\t")

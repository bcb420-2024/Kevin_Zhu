...
We can visuzlize the sample separation using a multidimenstional scaling plot
post normalization.
```{r warning=FALSE}
...
We can see from the MDS plot above that there does seem to be some separation 
between the control samples and the ones with the γ-secretase inhibitors. 

```{r warning=FALSE}
# model_design <- model.matrix(~samples_type[, "treatment"]+
#                                samples_type[, "cell line"])

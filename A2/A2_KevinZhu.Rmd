...
function. Applying the standard significance threshold, this time considering 
...
We conducted a threshold gene set enrichment analysis on the top hits, 
using for `g:Profiler` as the tool of choice. This decision was driven by

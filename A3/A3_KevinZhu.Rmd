...
included anywhere in the geneset. Interestingly, it is a known peripheral 
biomarker for Alzheimer's disease (AD). It is worth noting that the non-control 
cells exclusively underwent treatment with γ-secretase inhibitors. Thus, the 
presence of VSNL1 in the list of highly differentially expressed genes 
underscores the potential impact of γ-secretase on pathways beyond cholesterol 
biosynthesis that are relevant to AD.
...
beta (Aβ) metabolism and neuronal function.
